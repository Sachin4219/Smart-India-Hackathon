    ...
    <div>
      ...
      >
        ...
        <div className="space-y-8">
          {/* Pages group */}
          <div>
            <h3 className="banner text-xs uppercase text-slate-500 font-semibold pl-3">
            ...
            <ul className="mt-3">
              {/* Dashboard */}
              <SidebarLinkGroup activecondition={pathname === '/' || pathname.includes('judge')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                            ...
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${
                                  pathname === '/' || pathname.includes('judge') ? 'text-indigo-500' : 'text-slate-400'
                                }`}
                                d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z"
                              />
                              <path
                                className={`fill-current ${
                                  pathname === '/' || pathname.includes('judge') ? 'text-indigo-600' : 'text-slate-600'
                                }`}
                                d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z"
                              />
                              <path
                                className={`fill-current ${
                                  pathname === '/' || pathname.includes('judfe') ? 'text-indigo-200' : 'text-slate-400'
                                }`}
              ...
              {/* E-Commerce */}
              <SidebarLinkGroup activecondition={pathname.includes('cases')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            ...
                            >
                              <span className="banner text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Current 
                              </span>
                            </NavLink>
                          </li>
